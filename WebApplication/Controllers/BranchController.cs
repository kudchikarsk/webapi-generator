...
namespace WebApplication.Controllers
{
    ...
    public class BranchController : ApiController
    {
        ...
        public virtual async Task<IHttpActionResult> Get(int? page = null, int pageSize = 10, string orderBy = "Id", bool ascending = false, string query = null)
        {
            ...
            Expression<Func<Branch, bool>> filter = e => query == null || query == "null";
        ...
        public virtual IHttpActionResult GetSuggestions(string searchTerm)
        {
            ...
            Expression<Func<Branch, bool>> searchExpression = e => searchTerm == null || searchTerm == "null";
        ...
        public virtual IHttpActionResult Put(long id, [FromBody] UpdateBranch value)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
